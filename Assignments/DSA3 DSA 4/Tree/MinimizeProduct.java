 ...
 * Problem Statement
 * The product sum of two equal length arrays num1 and num2 is equal to the sum
 * of a[i] * b[i] for all 0 <= i < a.length (0- indexed).
 * For example, if num1 = [1, 2, 3, 4] and num2 = [5, 2, 3, 1], the product sum
 * would be 1*5 + 2*2 + 3*3 + 4*1 = 22.
 * Given two arrays num1 and num2 of length n, return the minimum product sum if
 * you are allowed to rearrange the order of the elements in num1.
 * Input
 ...
 * 
 * Explanation :
 * We can rearrange num1 to become [3, 5, 4, 2]. The product sum of [3, 5, 4, 2]
